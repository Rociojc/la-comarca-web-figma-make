...
export const MenuItem: React.FC<MenuItemProps> = ({ name, description, price }) => (
  <div className="flex justify-between items-center py-4 border-b border-stone-200 last:border-0 hover:bg-stone-50 px-4 -mx-4 transition-colors rounded-lg cursor-pointer">
    <div className="pr-4">
